            ...
            <div class="panel-heading">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="1">
                    <?php foreach ($saldo as $data):
                        $lc= $data->LINEA_CRED;
                        $pedidos = $data->COMPROMETIDO ;
                        $facturas = $data->COMPROMETIDO2;
                    ...
                    <tr>
                        ...
                        <td width="6%"></td>
                        <td width="47%"><label style="color:#DF3A01">&nbsp;&nbsp; Saldo Vencido: $ <?php echo number_format($data->VENCIDO,2)?></label></td>
                    </tr>
                    <tr>
                        <td><label>&nbsp;&nbsp;&nbsp; Pedidos en Transito: $ <?php echo number_format($data->COMPROMETIDO ,2,".",",");?> </label></td>
                        <td width="6%"></td>
                        <td><label style = "color:#0080FF">&nbsp;&nbsp; Saldo sin Vencer: $ <?php echo number_format($data->COBRANZA,2)?> </label><br></td>
                    </tr>
                    <tr>
                        <td> <label style="color:green" >&nbsp;&nbsp;&nbsp; Pedidos Facturados: $ <?php echo number_format( $data->COMPROMETIDO2,2)?></label></td>
                        <td width="6%"></td>
                        <td> <label style="color:#01DFA5">&nbsp;&nbsp; Acreedores: $ <?php echo number_format(0,2) ?></label></td>
                    </tr>
                    <tr>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        ...
                        ?>
                            <tr class="odd gradex" <?php echo $color;?>>
                                ...
                                <td><?php echo substr($data->FECHA_INI_COB,0,10)?></td>
                                <td>
                                ...
                                <td><?php echo substr($data->FECHA_INI_COB, 11,9)?></td>
                                <td></td>
                                <td></td>
