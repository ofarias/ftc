                                  ...
                                  <tbody>
                                        ...
                                        <tr class="odd gradeX" >
                                         <!--<tr class="odd gradeX" style='background-color:yellow;' >-->
                                            ...
                                            <td><a href="index.php?action=CarteraxCliente&cve_maestro=<?php echo $data->CLAVE;?>"  class="btn btn-info" target="popup" onclick="window.open(this.href, this.target, 'width=1200,height=1320'); return false;"><?php echo $data->SUCURSALES;?></a></td>
