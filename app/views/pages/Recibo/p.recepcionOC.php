                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-aplicapago">
                                  ...
                                  <tbody>
                                        ...
                                        foreach ($ordenes as $data):
                                                ...
                                                if($data->STATUS_LOG == 'Total'){
                                                    $color="style='background-color:#e7feb1 '";
                                                }
                                            ?>
                                        <tr class="odd gradex" <?php echo $color?> title="<?php echo 'Vueltas: '.$data->VUELTA?>">
                                            <td><?php echo $data->CVE_DOC;?> <br/><b><?php echo ($pre=='')? $data->STATUS_LOG:$pre?></b></td>
                                            ...
                                            <td>
                                               ...
                                               <!-- </form> -->   
                                                <?php }else{?>
                                                    <font color="blue">Solo se pueden recibir<br/>Ordenes Finalizadas</font>
                                                <?php }?>
                                            </td>
                                            <td>
                                                <?php if($data->STATUS_LOG == 'Total'){?>
                                            ...
                                            <?php }else{?>
                                                    <font color="red">Solo se pueden Rechazar<br/>Ordenes Finalizadas</font>
                                            <?php }?>
                                            </td>                       
                                        </tr>
                                        <?php endforeach; ?>
