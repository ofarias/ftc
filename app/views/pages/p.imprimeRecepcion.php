                                  ...
                                  <tbody>
                                       ...
                                       <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success" value="enviar" type="submit" name="imprimeRecep" <?php echo (!empty($data->ID_RECEPCION))? "":"disabled='disabled'" ?> > <?php echo ($data->IMPRESION > 0)? 'Re-Imprimir':'Imresion' ?></button>
                                                </form>
                                            </td>
                                        </tr>
