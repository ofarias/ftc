                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-foliofacturas">
                                  ...
                                  <tbody>
                                       ...
                                       <tr class="odd gradeX" <?php echo $color;?> id="linea_<?php echo $i?>">
                                            ...
                                            <?php echo (substr($data->DOCUMENTO,0,2) == 'FP')? "<br/> <a href='/Facturas/facturaPegaso/".$data->DOCUMENTO.".pdf' download> <img border='0' src='app/views/images/pdf.jpg' width='25' height='30'></a> <a href='/Facturas/facturaPegaso/".$data->DOCUMENTO.".xml' download> <img border='0' src='app/views/images/xml.jpg' width='25' height='30'></a>":'' ?>  <br/><?php echo (empty($data->FACTNC2))? '':"$data->FACTNC2<br/>" ?>

                                            <?php echo ($data->DOCUMENTO == $data->HISTORIAL)? '':$data->HISTORIAL?><br/> $ <?php echo number_format($data->SALDO_DOC,2)?>  </td>
