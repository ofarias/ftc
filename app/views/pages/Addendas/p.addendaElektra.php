    ...
    <div class="form-horizontal col-lg-12">
        <div class="panel panel-default">
            <div class="panel panel-heading">
                <h3>Datos para generar la Addenda Elecktra </h3>
            </div>
            <br />
            <div class="panel panel-body">
                <form action="index.php" method="post" id="formdoc">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="descripcion" class="col-lg-2 control-label">R RI: </label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="rri" placeholder="Numero de entada" required = "required"maxlength="150"/><br>
                                </div>
                        </div>
                </div>
            <div>
                <div class="panel-footer">
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <button name="addendaElektra" type="submit" value="enviar" class="btn btn-warning" form="formdoc">Guardar <i class="fa fa-floppy-o"></i></button>
