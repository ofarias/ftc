    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4>Documentos del cliente <?php echo $cliente->NOMBRE?></h4>
            </div>
            <!-- /.panel-heading -->
<?php if(count($exec) >0 ){?>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        ...
                        <tbody>
                            ...
                            <tr id = '$ln'>
                                ...
                                <td align="center"><input type="button" class="btn btn-danger" name="Quitar" onclick="quitarReq(<?php echo $ln?>, <?php echo $row->ID_DOC?>, '<?php echo $row->CVE_CLI?>', '<?php echo $row->NOMBRE?>' )" value="Quitar"> </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
...
<?php }?>
            <div class="panel-footer text-right">
                ...
                <form action="index.php" method="post">
                    ...
                    <input type="button" name="actualizar" value="Actualizar" class="btn btn-info" id="actualizar" >
                    <button name="AgregarDocumentoACliente" class="btn btn-success">Agregar <i class="fa fa-plus"></i></button>
                </form>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function quitarReq(ln, iddoc,cl, n){
        if(confirm('Desea quitar '+n+ ' como un requisito?')){
            $.ajax({
                url:'index.php',
                type:'post',
                dataType:'json',
