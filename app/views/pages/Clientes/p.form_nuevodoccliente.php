                   ...
                   <!-- <div class="form-group text-right">
                    ...
                    <div class="form-group">
                        <label for="copias" class="col-lg-2 control-label">Cliente: </label>
                            <div class="col-lg-8">         
                                <input type="hidden" name="cliente" value="<?php echo $_SESSION['ClaveCliente']?>">  
                                <input type="text" class="form-control" name="cli" value="<?php echo '('.$_SESSION['ClaveCliente'].') '.$clie->NOMBRE;?>" required = "required" readonly/><br>
                            </div>
                    </div>                   
                    <div class="form-group">
