                                  ...
                                  <tbody>
                                       ...
                                       <form action = "index.php" method="post" >
                                            ...
                                            <select name="proveedor" >
                                                ...
                                                <option value = "<?php echo $data->CLAVE?>"  <?php echo ($data->ID = 1)? 'select="selected"':''?>><?php echo $data->NOMBRE?></option>
                                            <?php endforeach; ?>
                                            </select>
                                            </td>
                                            ...
                                            <td>
                                                <input type="text" name="destino" required="required" >
                                            </td>
                                            <td>
                                                <button name="guardaDeudor" value="enviar" type ="submit" class="btn btn-success"> Guardar </button>
                                            </td>
                                        </form>
                                        </tr> 
                                 </tbody>
