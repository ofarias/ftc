	...
	<div class="col-lg-6">
		<form action="index.php" method="post" class="form-group">
			...
			<select name="rol" class="form-control">
				...
				<option value="usuario">Cuentas x Cobrar</option>
				<option value="ventas">Ventas</option>
				<option value="compras">Compras</option>
				<option value="recepcion">Logistica</option>
        <option value="sumunistros">Suministros</option>
        <option value="cxcc">Cuentas x Cobrar</option>
			</select>
