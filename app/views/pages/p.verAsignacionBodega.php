                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-aplicapago">
                                  ...
                                  <tbody>
                                        ...
                                        <tr id="titulo_<?php echo $i?>">
                                            ...
                                            <td><input type="number" name="cantRec" max="<?php echo $data->ASIGNADO?>" min="0" id="cantRec_<?php echo $i?>">
                                                <input type="hidden" name="cantOr" id="cantOr_<?php echo $i?>" value="<?php echo $data->ASIGNADO?>">
                                            </td>
