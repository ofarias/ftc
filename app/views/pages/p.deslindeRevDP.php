                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Deslinde Revision dos pasos del Dia.
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                       ...
                                       <tr>
                                            ...
                                            <td><button type="submit" name="salvaMotivoDeslindedp" class="btn btn-warning">Guardar<i class="fa fa-save"></i></button></td>
                                            </form>
                                        </tr> 
                                        <?php endforeach; ?>
                                 </tbody>
...
<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                Deslinde Revision dos pasos General.
                        </div>
                        <!-- /.panel-heading -->
                           <div class="panel-body">
                            <div class="table-responsive">                            
