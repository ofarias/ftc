                                  ...
                                  <tbody>
                                        ...
                                        <tr class="odd gradeX" <?php echo $color;?>>
                                         <!--<tr class="odd gradeX" style='background-color:yellow;' >-->
                                            ...
                                            <td>
                                            <input name="cantn" type="number" step="any" min = 0 max="<?php echo $RECEPCION?>" value="<?php echo $cantemp?>" id="cantn_<?php echo $i;?>" required="required" onchange="validafaltante(this.value, <?php echo $i;?>)" onkeypress="return pulsar(event)"/>
                                            </td>
                                            <td>
