                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-aplicapago">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Descargar Impresion<br/> Ver Devuelto</th>
                                            <th>Dejar de Ver</th>
                                            <th>Genera NC</th>
                                        </tr>
                                    </thead>                                   
                                  <tbody>
                                        ...
                                        foreach ($recepciones as $data):
                                            ...
                                            $i++;
                                            if(substr(trim($data->FACTURA),0,1) == '0' or substr($data->FACTURA,0,1) == 'P'){
                                                $saldo='N/A';
                                            }else{
                                        ...
                                        <tr id="<?php echo $i?>">
                                            ...
                                            <td><?php echo $data->FACTURA.'<br/><font color="blue"> $ '.$saldo.'</font>'?></td>
                                            <td><?php echo $data->NOMBRE;?></td>
                                            <td><?php echo $data->USUARIO_DEV ;?></td>
                                            <td><?php echo $data->FECHAEMPAQUE;?></td>
                                            <td><?php echo $data->FECHA_ULTIMA_DEV?></td>
                                            <td><?php echo $data->MOTIVO.'<br/>'.$data->NOTAS_CREDITO;?></td>
                                            <td><?php echo $data->IMPRESION_DEV;?></td>
                                            <td><a href='/Devoluciones/<?php echo $archivo?>.pdf' download="/Devoluciones/<?php echo $archivo?>.pdf">Ver Impresion</a><br/> <a href="index.php?action=verDetalleDevolucion&idd=<?php echo $data->FOLIO_DEV?>" target="popup" onclick="window.open(this.href, this.target, 'width=1200,height=820'); return false;"><font color="red">Ver Devuelto</font></a> </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="index.php?action=generaNCold&idd=<?php echo $data->FOLIO_DEV?>" onclick="verifica(<?php echo $data->FOLIO_DEV?>)">Genera NC</button>
                                                <?php }?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
...
function verifica(idd){
    alert('Id devolucion' + idd);
}
