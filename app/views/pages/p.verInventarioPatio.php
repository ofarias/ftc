                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr class="odd gradeX"  id="tr_<?php echo $i?>" <?php echo $color?>>
                                        ...
                                        <td><input name= "cantidad" type="number" step="any" value="<?php echo $data->RECEPCION -$data->EMPACADO;?>" min="0.001" class="conteo" original="<?php echo $data->RECEPCION-$data->EMPACADO?>" info="<?php echo $data->ID.':'.($data->RECEPCION-$data->EMPACADO).':'.$data->PROD.':'.(($data->COSTO*1.23) * 1.16).':'.$data->COTIZA?>"  onchange="revisar(<?php echo $i?>)" id="cantf_<?php echo $i?>" > </td>
                                        <td><input type="text" name="unidad" placeholder="Unidad de Medida" value="<?php echo $data->UM;?>" disabled="disabled"></td>
                                        <td align="right"><input type="number" step="any" name="costo" placeholder="<?php echo (($data->COSTO*1.23) * 1.16)?>" value="<?php echo (empty($data->COSTO))? '0':(($data->COSTO*1.23) * 1.16); ?>"  disabled="disabled" /> </td>
