...
<div class="panel panel-body">
		...
		<form action="index.php" method="post">
            ...
            <div class="form-group">
				...
				<div class="col-lg-10">
					<select name="linea" class="form-control" readonly="readonly">
		...
		<div class="form-group">
				...
				<div class="col-lg-10">
				<input type="text" maxlength="100" class="form-control" name="generico" readonly="readonly" value="<?php echo $data->GENERICO?>" /><br>
				</div>
			</div>
			<div class="form-group">
				<label for="sinonimos" class="col-lg-2 control-label">Sinonimos: </label>
				<div class="col-lg-10">
					<input type="text" maxlength="150" class="form-control" name="sinonimos" readonly="readonly" placeholder="sinonimos" value="<?php echo $data->SINONIMO?>"/><br>
				</div>
			</div>
			<div class="form-group">
				<label for="calificativo" class="col-lg-2 control-label">Calificativo: </label>
				<div class="col-lg-10">
					<input type="text" maxlength="200" class="form-control" name="calificativo" readonly="readonly" placeholder="Calificativos del producto"  value="<?php echo $data->CALIFICATIVO?>"/><br>
				</div>
			</div>
			<div class="form-group">
				<label for="medidas" class="col-lg-2 control-label">Medidas: </label>
				<div class="col-lg-10">
					<input type="text" maxlength="20" class="form-control" name="medidas" readonly="readonly" placeholder="medidas" value="<?php echo $data->MEDIDAS?>"/><br>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
						<select name="unidadmedida" readonly="readonly">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<select name="empaque" readonly="readonly">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">			
					<input type="text" class="form-control" id="prov1" readonly="readonly" name="prov1" placeholder ="Codigo proveedor1" value="<?php echo $data->CLAVE_DISTRIBUIDOR?>"/><br>	
				</div>
			</div>
			<div class="form-group">
				<label for="codigo_prov1" class="col-lg-2 control-label">Codigo Producto Proveedor Base: </label>
					<div class="col-lg-10">
						<input type="text" class="form-control" name="codigo_prov1" readonly="readonly" placeholder ="Codigo producto proveedor1" value="<?php echo $data->CLAVE_FABRICANTE?>"/><br>
					</div>
			</div>
			 ...
			 <div class="form-group">
                <label for="Codigo prov1" class="col-lg-2 control-label">Codigo Fabricante: </label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="sku" readonly="readonly" placeholder ="Codigo Fabricante" value="<?php echo $data->SKU?>"/><br>
                    </div>
            </div>
			...
			<div class="form-group">
    			<div class="col-lg-offset-2 col-lg-10">
    				<input type="hidden" name="tipo" value="costo" >
    				<input type="hidden" name="doco" value="<?php echo $doco?>">
    				<input type="hidden" name="par" value="<?php echo $par?>">
    				<button name="guardaFTCART" type="submit" value="enviar" class="btn btn-warning"> Actualizar Costo <i class="fa fa-floppy-o"></i></button>
				</div>
			</div>
		</form>
		<?php endforeach ?>
