                        ...
                        <!-- /.panel-heading -->
                           <div class="panel-body">
                            <div class="table-responsive">                            
                                <table class="table table-striped table-bordered table-hover" id="dataTables-AsignaUnidadReparto">
                                    <thead>
                                        <tr>
                                  ...
                                  <tbody>
                                       ...
                                       <tr class="odd gradeX" <?php echo $color;?>>
                                            ...
                                            <td>
                                                ...
                                                <input type="button" name="recibir" value="Recibir" onclick="recibirDoc(<?php echo $i?>)" id="btn_<?php echo $i?>">
                                                <p id="usu_<?php echo $i?>"></p>
                                            </td> 
                                                <?php }else{?>
                                                <b><font color="<?php echo $font?>"><?php echo $data->U_LOGISTICA.'<br/>'.$data->FECHA_U_LOGISTICA?></font></b>
        ...
        if(confirm('Desea Recibir el Documento: ' + doc)){
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.status == 'ok'){
                        alert('Se recibio por el usuario' + data.usuario + ', con fecha del ' + data.fecha);
                        document.getElementById("usu_"+i).innerHTML='<font color="#17202a">'+data.usuario+'<br/>'+data.fecha + '</font>';
