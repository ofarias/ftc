                                        ...
                                        <tr class="odd gradeX" <?php echo $color;?> id="linea_<?php echo $i?>">
                                            ...
                                            <td><?php echo $data->DOCUMENTO;?>
                                                <?php if(substr($data->DOCUMENTO,0,2) == 'PF'){?>
                                                 <a onclick="impPreFact(<?php echo substr($data->DOCUMENTO,2,10)?>, '<?php echo $data->CVE_FACT?>')"><img border='0' src='app/views/images/pdf.jpg' width='25' height='30'></a>
                                                <?php }?>
                                            </td>
                                            <td><a href="index.php?action=verDetalleDevolucion&idd=<?php echo substr($data->FOLIO_DEV,3,10)?>" target="popup" onclick="window.open(this.href, this.target, 'width=1200,height=820'); return false;"><?php echo $data->FOLIO_DEV?></a></td>
                                            ...
                                            <?php }?>
                                            <td>
                                                <?php if($tipo2 == 6 and $tipoUsuario !='G'){?>
