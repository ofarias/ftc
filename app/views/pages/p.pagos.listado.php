                        ...
                        <tbody>
                            ...
                            foreach ($exec as $data):
                                ...
                                <tr  class="odd gradeX"  style='background-color:#ffe6e6'>    
                                    ...
                                    <td><?php echo '('.$data->CVE_CLPV.') '.$data->NOMBRE?> <a href="index.php?action=verHistorialSaldo&prov=<?php echo $data->CVE_CLPV?>" target="popup" onclick="window.open(this.href, this.target, 'width=1200,height=820'); return false;" ><?php echo '<font color = "red"> Saldo ('.number_format($data->SALDOPROV*1.16,2).')</font>';?></a></td>
