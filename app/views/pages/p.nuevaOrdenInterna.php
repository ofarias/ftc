...
<div id="selProv">
    <select id="prov" onchange="proveedor(this.value)">
                ...
                $.ajax({
                    ...
                    success:function(data){
                            ...
                            document.getElementById('selProv').classList.add('hide');
                                ...
                                midiv.innerHTML = "<p>"+ prod + " <font color='blue'>&nbsp;&nbsp; Cantidad: " + cant + " </font> <font color='red'>&nbsp;&nbsp; Total : $ "+ data.total + "</font>"+"</p>";
