...
<div>
    ...
    <form action="index.php" method="post">
        ...
        <button name="FORM_ACTION_PAGO_FACTURAS" type="submit" value="enviar" class = "btn btn-info"> Buscar </button>    
    </form>
</div>
                                         ...
                                         <!--<tr class="odd gradeX" style='background-color:yellow;' >-->
                                            ...
                                            <td>
                                                <form action="index.php" method="post">
                                                    ...
                                                    <button type="submit" name="aplicarPago2" value="enviar" <?php echo (($key->SALDO - $total)< 0)? "disabled='disabled'":""?> >Aplicar Pago </button>
                                                </form>
                                                </td>
                                        </tr>
                                        </form>
