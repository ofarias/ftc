                        ...
                        <!-- /.panel-heading -->
                           <div class="panel-body">
                            <div class="table-responsive">                            
                                <table class="table table-striped table-bordered table-hover">
                                  ...
                                  <tbody>
                                       ...
                                       <tr>
                                            ...
                                            <td align="center" id="rec_<?php echo $data->ID?>"><?php echo $data->RECEPCION?></td>
                                            <td align="center" id="recf_<?php echo $data->ID?>"><?php echo $data->REC_FALTANTE;?></td>
                                ...
                                <!-- <input type="hidden" name="idpreoc" id="idpreoc" value="<?php echo $data->ID?>">
                                 <input type="button" name="rec" value="recalcular" onclick="recidpreoc(idpreoc.value)">-->
                      </div>
            </div>
        </div>
    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" >
                                  ...
                                  <tbody>
                                       ...
                                       <tr class="odd gradeX" <?php echo $color?> >
                                            ...
                                            <td align="center"><?php echo $data->CVE_DOC;?><br/><font color="blue"><?php echo $data->FECHA_OC?></font></td>
...
<script type="text/javascript">
  function recidpreoc(id){
    alert('Recalcuala el id: ' + id);
    $.ajax({
      url:'index.php',
      method:'POST',
      dataType:'json',
      data:{actPreoc:1,idpreoc:id},
