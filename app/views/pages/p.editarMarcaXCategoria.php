...
<div class="panel panel-body">
		...
		<form action="index.php" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="marca" value="<?php echo $data->CLAVE_MARCA?>" readonly="readonly" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label for="marca1" class="col-lg-2 control-label">Auxiliar Actual: </label>
				<div class="col-lg-10">
					<input type="text" name="a" class="form-control" value="<?php echo $data->AUXILIAR?>" readonly="readonly">
				</div>
			</div>
			<label> </label>
			<div class="form-group">
				<label for="marca1" class="col-lg-2 control-label">Auxiliar: </label>
				<div class="col-lg-10">
					<select name ="auxiliar" required="required">
			...
			<div class="form-group">
    			<div class="col-lg-offset-2 col-lg-10">
					<button name="editaMXC" type="submit" value="enviar" class="btn btn-warning"> Guardar <i class="fa fa-floppy-o"></i></button>
				</div>
			</div>
		<?php endforeach; ?>
		</form>
