        ...
        <div class="row">
            ...
            <div class="col-md-4">
               ...
               <!-- <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Asignacion Unidad Edo Mex</h4>
                    </div>
                    <div class="panel-body">
                        <p>Asignacion de Unidad Edo Mex</p>
                        <center><a href="index.php?action=arutaedomex" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>-->
            <div class="col-md-4">
           ...
           <!-- Finaliza Sub menu para Parcial-No-Enrutar-->
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Corrige Ruta</h4>
                    </div>
                    <div class="panel-body">
                        <p>Corrige Rutas</p>
                        <center><a href="index.php?action=corrigeruta" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>                
