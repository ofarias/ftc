<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Documentos Listos para Recibir</h4>
                    </div>
                    <div class="panel-body">
                        <p>Recibir Documentos</p>
                        <center><a href="index.php?action=seguimientoCajasRecibir&tipo=6" class="btn btn-default"><img src="app/views/images/Clipboard-Paste-icon.png"></a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Documentos en Cobranza</h4>
                    </div>
                    <div class="panel-body">
                        <p>Documentos en Cobranza</p>
                        <center><a href="index.php?action=seguimientoCajasRecibir&tipo=7" class="btn btn-default"><img src="app/views/images/Clipboard-Paste-icon.png"></a></center>
                    </div>
                </div>
            </div>
            <!--
