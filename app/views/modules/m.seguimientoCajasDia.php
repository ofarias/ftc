            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> <?php echo 'Mes: '.$m['mes'].' -- Año -- '.$m['anio'].' Dia: --> '.$m['dia']?> </h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <center><a href="index.php?action=seguimientoCajasDiaDetalle&mes=<?php echo $m['mes'];?>&anio=<?php echo $m['anio']?>&dia=<?php echo $m['dia']?>" class="btn btn-default">Ver Detalle</a></center>
                    </div>
                </div>
            </div>
            <?php endforeach;?>
