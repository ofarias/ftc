        ...
        <?php }?>
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p></p>
                        <center><a href="index.php?action=verInventarioBodega" class="btn btn-default"><img src="app/views/images/boxes-brown-icon.png"></a></center>
                    </div>
                </div>
            </div> 
            <div class="col-md-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Liberar Pedido</h4>
                    </div>
                    <div class="panel-body">
                        <p></p>
            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Solicitudes Rechazadas</h4>
                    </div>
                    <div class="panel-body">
