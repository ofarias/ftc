        ...
        <div class="row">
            ...
            <?php } ?>
             <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i>Solicitid de Refacturacion</h4>
                    </div>
                    <div class="panel-body">
                        <p>Refacturar desde Bodega</p>
                        <center><a href="index.php?action=verSolRefacturacion" class="btn btn-default"><img src="app/views/images/invoice.png"></a></center>
                    </div>
                </div>
            </div>        
        </div>
