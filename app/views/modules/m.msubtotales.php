                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center><a href="index.php?action=vertotales&idf=<?php echo $CreaU->IDU;?>" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/custom-icon-design/flatastic-2/64/truck-icon.png"></a></center>
                        </div>
                    </div>
                </div>    
                <?php endforeach ?>
