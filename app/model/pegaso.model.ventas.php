...
WHERE CVE_DOC_COMPPAGO IS NULL AND (NUM_CPTO = 22 OR NUM_CPTO = 11 OR NUM_CPTO =10)";
    ...
    function cargaSae($doc, $folio, $serie, $uuid, $ruta, $rfcr){
        ...
        $doc = $serie.'0'.$folio;
        $this->query="EXECUTE PROCEDURE  SP_CARGA_CFDI_SAE($folio,'$serie','$doc', '123')";
        $this->EjecutaQuerySimple();
        $this->query = "UPDATE CFDI01 SET XML_DOC = '$myXMLData' WHERE CVE_DOC = '$doc'";
        $this->EjecutaQuerySimple();
        $this->query="EXECUTE PROCEDURE  SP_CARGA_FACTURA_SAE($folio,'$serie','$doc')";
        $this->EjecutaQuerySimple();
        $this->query="EXECUTE PROCEDURE  SP_CARGA_PARTIDAS_SAE($folio,'$serie', '$doc', '$uuid')";
        $this->EjecutaQuerySimple();
        $this->query="EXECUTE PROCEDURE  SP_CARGA_CUENM_SAE ($folio, '$serie', '$doc', '$uuid')";
        $this->EjecutaQuerySimple();
