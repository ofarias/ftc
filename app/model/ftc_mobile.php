...
class ftcwsmob {
    private $DBServer="35.238.171.71:3306";
    private $DBUser="filler";
    private $DBPaswd="sat2app";
    private $DBName="";
    private $cnx;
    protected $query;
    
    private function AbreCnx() {
        if($_SESSION['empresa']['mobile']==1){
            $DBName=$_SESSION['empresa']['bd_mobile'];
        }     
        ...
        $sdb = mysqli_select_db($this->cnx, $DBName);
        if (!$sdb) {
