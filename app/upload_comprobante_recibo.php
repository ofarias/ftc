...
if ($_FILES["fileToUpload"]["size"] > 50000000) {
    ...
    $uploadOk = 0;
        ...
        if (file_exists($target_file) or strtoupper($imageFileType) != ("PDF")) {
            ...
            $uploadOk = 0;
            $tipo = 'duplicado';
            $registro = $controller->guardaComprobante($target_file, $cotizacion, $mes, $anio, $dia, $tipo);
        }else{
            ...
            $tipo = 'ok';
            $respuesta = $controller->guardaComprobante($target_file, $cotizacion, $mes, $anio, $dia, $tipo);
        }
}
?>
