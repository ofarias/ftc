...
function ImpSolicitud2($idsol){
 ...
 function actualizaProveedorBBVA($datos){
   ...
   function addendaPropimex($docf, $oc, $entrada, $remision){
	...
	function polizaAutomatica($polizaAuto){
		$_SESSION['info']=$polizaAuto;
		$_SESSION['titulo']='Envio de Reporte de Polizas Automaticas';   //// guardamos los datos en la variable global $_SESSION
        include 'app/mailer/envioRepPolAuto.php';   ///  se incluye la classe Contrarecibo     
        if($mensaje == ''){
